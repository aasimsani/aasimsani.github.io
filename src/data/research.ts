...
export const research: ResearchEntry[] = [
  {
    ...
    paragraphs: [
      `A case study from my own experience with Orai: how power imbalances inside a founding team cascade into catastrophic failure.`,
    ],
  },
  {
    ...
    mat: "bleed",
    paragraphs: [
      `With Drs. Zahed Subhan, Liza Herzog, and David Hayes. A moderation/mediation analysis of how psychometric traits like resilience shape college students' decision to launch a startup.`,
